...
/**
 * amintado\pinventory\models\PurchaseFactorSearch represents the model behind the search form about `amintado\pinventory\models\Factor`.
 */
 class PurchaseFactorSearch extends Factor
{
    /**
     * @inheritdoc
     */
