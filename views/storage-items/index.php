...
/* @var $searchModel amintado\pinventory\models\StorageItemsSearch */
...
$this->title = Yii::t('common', 'Storage Items');
...
?>
<div class="storage-items-index">

    <h1><?= Html::encode($this->title) ?></h1>
    <?php // echo $this->render('_search', ['model' => $searchModel]); ?>

    <p>
        <?= Html::a(Yii::t('common', 'Create Storage Items'), ['create'], ['class' => 'btn btn-success']) ?>
